/*In alot of app, there are times we need to get info about the currently logged in user. So in these lecture, we will add a new api endpoint to get the current user.*/
