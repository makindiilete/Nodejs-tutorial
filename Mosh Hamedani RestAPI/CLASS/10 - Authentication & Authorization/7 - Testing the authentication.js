/*POSTMAN TIP : - You can save all your crud operations with their endpoints and request body in postman by clicking on the save button behind the Send button*/
...
/*Now if we test the authentication @ /api/auth and supply valid email and password, we get "true" else we get "invalid email & password"*/
