/*GOAL : - We want to implement auto scrolling in our chat application.
By auto-scroll : - When new messages comes in, the app will auto scroll to the recent message when the screen is filled up.

But in case where the user is checking the history, which means the user is not viewing the recent message, we will not auto scroll so it wont be disturbing to the user*/
